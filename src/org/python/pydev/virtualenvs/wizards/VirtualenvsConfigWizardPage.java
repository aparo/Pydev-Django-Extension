 ...
 * 
 */
package org.python.pydev.virtualenvs.wizards;
 ...
 */
public class VirtualenvsConfigWizardPage extends WizardPage {
	...
	public VirtualenvsConfigWizardPage(String pageName) {
		super(pageName);
